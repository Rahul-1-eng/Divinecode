...
export default function CreateContestPage() {
  ...
  async function createContest() {
    ...
    const owner = { name: ownerName, codeforcesHandle: ownerName };
    const cleanedMembers = mode === 'single' ? [owner] : [owner, ...members.filter((m) => m.name.trim() || m.codeforcesHandle.trim()).map((m) => ({ name: m.name.trim() || m.codeforcesHandle.trim(), codeforcesHandle: m.codeforcesHandle.trim() || m.name.trim() }))];
